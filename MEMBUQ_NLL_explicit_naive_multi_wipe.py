...
from qdax.core.map_elites_MBUQ_NLL_explicit_naive import MAPElites
    ...
    for i in range(num_iterations):
        ...
        # After the first generations, buffer via scoring function and container via model 
            ...
            for subdiv in range(nb_subdiv):
                ...
                ### Producing genotypes and associated scores with the scoring function
                subdiv_genotypes, subdiv_fitnesses, subdiv_fitnesses_var, subdiv_descriptors, subdiv_descriptors_var, random_key = map_elites.generate_batch(
                    repertoire=repertoire,
                    emitter_state=emitter_state,
                    random_key=random_key,
                )
...
def specify_arg():
    ...
    parser.add_argument("--algo_name", default="MEMBUQ_NLL_Explicit_Naive", type=str, help="Name of the algorithm")
