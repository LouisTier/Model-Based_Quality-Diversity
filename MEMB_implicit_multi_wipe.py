...
def specify_arg():
    ...
    parser.add_argument("--learning_rate", default=0.0001, type=float, help="Learning rate of the optimizer (Adam)")
    ...
    parser.add_argument("--algo_name", default="MEMB_Implicit", type=str, help="Name of the algorithm")
