...
from qdax.core.map_elites_MB_explicit_naive_old import MAPElites
...
def test_arm(
    ...
    init_variables = jax.random.uniform(
        subkey,
        shape=(sampling_size, num_param_dimensions),
        minval=min_param, 
        maxval=max_param, 
    )
    ...
    for i in range(num_iterations):
        ...
        # After the first generations, buffer via scoring function and container via model 
            ...
            # print("fitness model:", len(fitness_model))
...
if __name__ == "__main__":
    ...
    # python3 HPC_MEMB_explicit_naive.py --save_dir test_grid --task_name arm --first_train 500 --num_epochs 5 --per_data 0.5
    ...
    # # python3 HPC_MEMB_explicit_naive.py --save_dir test_grid  --task_name arm

    # first_train_list = [100, 200, 500, 800, 1000]  
    # num_epochs_list = [50, 125, 175, 300]         
