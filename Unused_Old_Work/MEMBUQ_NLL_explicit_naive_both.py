...
# from qdax.core.map_elites_MBUQ_NLL_explicit_naive_both_old import MAPElites
from Unused_Old_Work.map_elites_MBUQ_NLL_explicit_naive_both_old import MAPElites
from qdax.tasks.arm import arm_scoring_function, noisy_arm_scoring_function, both_scoring_function # Here
from qdax.utils.metrics import CSVLogger, default_qd_metrics_UQ
from qdax.utils.plotting import plot_map_elites_results_UQ
from qdax.core.stochasticity_utils_UQ import reevaluation_function_both, sampling_both # Here
...
method = "MEMBUQ_NLL_Explicit_Naive_both"
    ...
    # for i in range(num_iterations):
        ...
        if i <= model_start_training:
            ...
            buffer = replay_buffer.add_transitions_explicit(
                ...
                # descriptors=descriptors_noisy_arm,
        ...
        # to_predict generation before training, the NN uses the repertoire to predict some scores 
            ...
            # ### Predicting scores with the model
            # # fitness_model, descriptor_model, fitness_var_model, descriptor_var_model 
            # mean_fitness, mean_bd1, mean_bd2, std_fitness, std_bd1, std_bd2 = map_elites.model_batch_predict(
            #     model_dict=model_state,
            #     genotypes=genotypes,
            # )
