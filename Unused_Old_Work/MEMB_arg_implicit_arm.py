...
def specify_arg():
    ...
    parser.add_argument("--num_epochs", default=200, type=int, help="Number of epochs to train the model") # 200
...
if __name__ == "__main__":
    ...
    # python3 MEMB_arg_implicit_arm.py --save_dir results_sim_arg --first_train 1000 --num_epochs 200 --per_data 0.5

    args.task_name = "arm"

    # Save inputs parameters into txt 
    with open(f'{args.save_dir}/{method}/input_args_{args.task_name}_{time_format}.txt', 'w') as file:
        print(vars(args), file=file)
