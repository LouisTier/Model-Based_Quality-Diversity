...
if __name__ == "__main__":
    ...
    # python3 MEMB_explicit_naive.py --save_dir test_grid --task_name arm --first_train 500 --num_epochs 5 --per_data 0.5 (test everything work properly)
    # python3 MEMB_explicit_naive.py --save_dir results_sim_arg --task_name arm --first_train 500 --num_epochs 250 --per_data 0.5 ; python3 HPC_test_MEMB_explicit_naive.py --save_dir results_sim_arg --task_name noisy_arm --first_train 500 --num_epochs 250 --per_data 0.5 
    # (test result with previous method, above)
    # python3 MEMB_explicit_naive.py --save_dir results_sim_arg --task_name arm --first_train 1000 --num_epochs 5 --per_data 0.5 (test len of OT predictions)
