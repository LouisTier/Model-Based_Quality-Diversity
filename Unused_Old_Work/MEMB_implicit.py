...
from qdax.core.map_elites_MB_implicit import MAPElites
...
def specify_arg():
    ...
    parser.add_argument("--num_epochs", default=125, type=int, help="Number of epochs to train the model") # 200
    parser.add_argument("--per_data", default=0.8, type=float, help="Percentage of old data to be retained for next training session")
...
if __name__ == "__main__":
    ...
    # python3 MEMB_implicit.py --save_dir test_grid --task_name arm --first_train 500 --num_epochs 5 --per_data 0.5 (test everything work properly)
    # python3 MEMB_implicit.py --save_dir results_sim_arg --task_name arm --first_train 500 --num_epochs 250 --per_data 0.5 ; python3 HPC_test_MEMB_explicit_naive.py --save_dir results_sim_arg --task_name noisy_arm --first_train 500 --num_epochs 250 --per_data 0.5 
    # (test result with previous method, above)
    # python3 MEMB_implicit.py --save_dir results_sim_arg --task_name arm --first_train 1000 --num_epochs 5 --per_data 0.5 (test len of OT predictions)
    ...
    # # python3 MEMB_implicit.py --save_dir test_grid  --task_name arm
