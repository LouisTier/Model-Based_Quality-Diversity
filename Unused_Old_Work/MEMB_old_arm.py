...
from qdax.core.map_elites_MB_old import MAPElites
...
def test_arm(task_name: str, batch_size: int) -> None:
    ...
    model_start_training = 50 # Number of generations to fill container before training the model: 100 or 50
    freq_training = 25 # Number of generations between 2 training except the first one at model_start_training generations: 100 or 25
    ...
    num_epochs = 3 # Number of epochs at each training: 30 
