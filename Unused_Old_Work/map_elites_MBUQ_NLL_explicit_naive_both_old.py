...
class MAPElites:
    ...
    def init(
        ...
        # Here
        fitnesses_arm, fitnesses_var_arm, descriptors_arm, descriptors_var_arm, fitnesses_noisy_arm, fitnesses_var_noisy_arm, descriptors_noisy_arm, descriptors_var_noisy_arm, extra_scores, random_key = self._scoring_function(
    ...
    def update_buffer_beginning(
        ...
        repertoire = repertoire.add(genotypes, descriptors_noisy_arm, fitnesses_noisy_arm, descriptors_var_noisy_arm, fitnesses_var_noisy_arm, extra_scores)
        ...
        return repertoire, genotypes, fitnesses_arm, fitnesses_var_arm, descriptors_arm, descriptors_var_arm, fitnesses_noisy_arm, fitnesses_var_noisy_arm, descriptors_noisy_arm, descriptors_var_noisy_arm, emitter_state, metrics, random_key
    ...
    def generate_batch(
        ...
        return genotypes, fitnesses_arm, fitnesses_var_arm, descriptors_arm, descriptors_var_arm, fitnesses_noisy_arm, fitnesses_var_noisy_arm, descriptors_noisy_arm, descriptors_var_noisy_arm, random_key
    ...
    def train_model_v2(
        ...
        for epoch in range(num_epochs):
            ...
            (model_dict, train_losses, mse_losses, genotypes_batches, fitnesses_batches, bd1_batches, bd2_batches, fitnesses_var_batches, descriptors_var_batches, batch_num, l2_rate), _ = jax.lax.scan(
                self.scan_looping_batches, # Function to scan
                (model_dict, train_losses, mse_losses, genotypes_batches, fitnesses_batches, bd1_batches, bd2_batches, fitnesses_var_batches, descriptors_var_batches, batch_num, l2_rate), # Input args of the function
    ...
    def scan_looping_batches(
        ...
        model_dict, train_losses, mse_losses, genotypes_train, fitness_train, bd1_train, bd2_train, fitness_var_train, descriptors_var_train, batch_num, l2_rate = carry
        ...
        return (model_dict, train_losses, mse_losses, genotypes_train, fitness_train, bd1_train, bd2_train, fitness_var_train, descriptors_var_train, batch_num, l2_rate), None
    ...
    def check_model(
        ...
        fitness_var_val = fitness_var_val[0:end_idx]
        descriptors_var_val = descriptors_var_val[0:end_idx]
        ...
        # return fitness_val_model, fitness_val, descriptors_val_model, descriptors_val, fitness_var_val_model, fitness_var_val, descriptors_var_val_model, descriptors_var_val, avg_val_loss
        return val_mean_fitness, val_mean_bd1, val_mean_bd2, val_std_fitness, val_std_bd1, val_std_bd2, fitness_val, bd1_val, bd2_val, fitness_var_val, descriptors_var_val, avg_val_neg_LL
    ...
    def model_batch_predict(
        ...
        # return fitness_model, descriptors_model, fitness_var_model, descriptors_var_model
