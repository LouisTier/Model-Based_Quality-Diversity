...
Individual Research Project at Imperial College London to work properly with MAP-Elites-Sampling. 
...
class MAPElites:
    """Core elements of the MAP-Elites-Sampling algorithm.
    ...
    def init(
        ...
        """
        Initialize a Map-Elites-Sampling repertoire with an initial population of genotypes.
